...
export default function Footer(props) {
    return (
        <div className={props.toggle ? "Footer FooterNight" : "Footer"}>
            ...
            <nav>
                <ul>
                    <li><a href="https://drive.google.com/file/d/1V9aUk79pMPNuxODgle9JL5Gwcd55XXKT/view?usp=share_link" target="_blank" rel="noreferrer" download="resume" className="Link footerLink"><AiOutlineFileText style={{height: '2rem', width: '3rem'}}/></a></li>
