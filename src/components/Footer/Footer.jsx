...
export default function Footer(props) {
    return (
        <div className={props.toggle ? "Footer FooterNight" : "Footer"}>
            ...
            <nav>
                <ul>
                    <li><a href="https://drive.google.com/file/d/1YpJlHjD4-xLiO2jEqMzHzShInV6-21Mn/view?usp=sharing" target="_blank" download="resume" className="Link footerLink"><AiOutlineFileText style={{height: '2rem', width: '3rem'}}/></a></li>
